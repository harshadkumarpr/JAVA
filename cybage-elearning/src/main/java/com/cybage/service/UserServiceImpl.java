...
public int enrollCourse(String username, int courseid) throws Exception {
	...
	public void addVideoHistory(int videoid, String remoteUser) throws Exception{
		userDao.addVideoHiistory(videoid,remoteUser);
	...
	public String getVideoStatus(int videoid, String remoteUser) throws Exception{
		...
		return userDao.getVideoStatus(videoid,remoteUser);
	}


	public void updateVideoStatus(int videoid, String remoteUser) throws Exception {
		userDao.updateVideoStatus(videoid,remoteUser);
	...
	public String getCourseStatus(String remoteUser, int courseid) throws Exception{
		...
		return userDao.getCourseStatus(remoteUser,courseid);
	}
