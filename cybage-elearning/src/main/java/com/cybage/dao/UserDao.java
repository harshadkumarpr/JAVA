...
public interface UserDao 
{
	...
	void addVideoHiistory(int videoid, String remoteUser) throws Exception;

	String getVideoStatus(int videoid, String remoteUser) throws Exception;

	void updateVideoStatus(int videoid, String remoteUser) throws Exception;

	String getCourseStatus(String remoteUser, int courseid) throws Exception;
